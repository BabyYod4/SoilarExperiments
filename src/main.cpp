...
//   if ( CreateRfm95W(&transmitter, &interface, &settings1) == LORA_ERROR_WRONG_DEVICE ) {
...
//   buff1[3]=i; buff2[3]=i; buff3[3]=i; buff4[3]=i;
//   i++;

//   transmitter.send(buff1, 8);
//   Serial.print("Device 1 - Sending packet '");
//   Serial.print(buff1[3]); Serial.print("-"); Serial.print(buff1[4]); Serial.print("-"); Serial.print(buff1[5]);
//   Serial.print("'\r\n");
//   delay(1000);
  
//   transmitter.hop(&settings2);
//   transmitter.send(buff2, 8);
//   Serial.print("Device 2 - Sending packet '");
//   Serial.print(buff2[3]); Serial.print("-"); Serial.print(buff2[4]); Serial.print("-"); Serial.print(buff2[5]);
//   Serial.print("'\r\n");
//   delay(950);
...
//   Serial.print(buff3[3]); Serial.print("-"); Serial.print(buff3[4]); Serial.print("-"); Serial.print(buff3[5]);
//   Serial.print("'\r\n");
//   delay(850);
...
//   Serial.print(buff4[3]); Serial.print("-"); Serial.print(buff4[4]); Serial.print("-"); Serial.print(buff4[5]);
//   Serial.print("'\r\n");
...
uint8_t buff[11] = {0};
uint8_t buff2[8] = {0xFF, 0x01, 0x00, 0x00, 0x0D, 0xDD, 0xFF, 0xFF};
